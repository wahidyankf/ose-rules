...
Read .agents/skills/creating-in-the-field-tutorials/SKILL.md completely, resolve every relative resource from that skill directory, and follow it as authoritative before acting.
