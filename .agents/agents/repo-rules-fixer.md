...
obvious it looks: [Principle Traceability](../../repo-governance/conventions/structure/principle-traceability.md)
records that link rather than inferring it, so a principle the fixer picked would be an inference.
