...
4. **What does it say?** One obligation per statement, falsifiable, with its strength carried by the wording, its reason
   stated, its principles recorded per
   [Principle Traceability](../../repo-governance/conventions/structure/principle-traceability.md), and its enforcement
   named, as Rule Definition requires.
5. **What shape?** A convention follows
   [Convention Documents](../../repo-governance/conventions/writing/convention-documents.md). Every document carries its
   metadata per [Artifact Metadata](../../repo-governance/conventions/structure/artifact-metadata.md), stays within
