...
the route, branch lifespan, worktrees, and cleanup;
[Integration Hygiene](../../../repo-governance/development/workflow/integration-hygiene.md) fixes checking, rebasing,
and a red trunk; [Thematic Commits](../../../repo-governance/development/workflow/thematic-commits.md) shapes each
commit; [Commit Authorization](../../../repo-governance/development/workflow/commit-authorization.md) grants permission;
and
