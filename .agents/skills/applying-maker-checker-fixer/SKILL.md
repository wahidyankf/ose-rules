...
[Agent Authoring](../../../repo-governance/development/agents/agent-authoring.md) gives: once it edits, nothing
...
[Bounded Convergence](../../../repo-governance/development/workflow/bounded-convergence.md) decides what happens next.
