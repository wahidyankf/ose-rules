...
affect were assessed per [Specification Maintenance](../../development/quality/evidence/specification-maintenance.md),
and any scenario that specifies the behaviour was added or updated first per
...
- [Gherkin Implementation Review](gherkin-implementation-review.md) checks that each scenario's test fails when its
  behaviour breaks.
- [Exploratory and Usability Review](exploratory-usability-review.md) judges the user-facing result once automated
  checks are green.
