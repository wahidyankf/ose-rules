...
inside projects, the standard files per
[Repository Documentation Files](../../conventions/writing/repository-documentation-files.md), and a plan's documents
where they describe the repository. Governance and agent instructions stay with
...
- [Docs Quality Gate](../quality/docs-quality-gate.md) audits documents, hands its findings here, and audits the
  repaired state again.
