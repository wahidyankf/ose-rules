...
[Project READMEs](../project-readmes.md) state each project's stack, commands, and test levels, and
[Test Boundaries and Gates](../../../development/quality/testing/test-boundaries-and-gates.md) places every omitted
...
- **Adopter Decisions.** Every Adopter Decision row of each adopted standard and skill, plus the coverage-floor and
  ...
  [Layers and Adapters](../../../development/quality/testing/behaviour-driven-development/002-layers-and-adapters.md)
