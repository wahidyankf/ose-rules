...
in the `extensions` group of its [repository configuration file](../repository-configuration.md), never a second place
...
[Top-Level Schema](../repository-configuration/001-top-level-schema.md) requires every extension to name an owner. The
