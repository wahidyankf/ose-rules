...
1. [The Exit Status Contract](command-line-interface-details/001-exit-status-contract.md)
2. [Stream Discipline](command-line-interface-details/002-stream-discipline.md)
3. [Standard Input](command-line-interface-details/003-standard-input.md)
4. [Machine-Readable Output](command-line-interface-details/004-machine-readable-output.md)
