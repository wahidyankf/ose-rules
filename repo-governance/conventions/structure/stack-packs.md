...
This convention implements [One Source Per Fact](../../principles/one-source-per-fact.md),
...
Skills sit outside the [Capability Naming](capability-naming.md) grammar, which already excludes them; the prefixes are
...
A pack reaches a repository only by an explicit [Adopt Artifact](../../workflows/adoption/adopt-artifact.md) request,
