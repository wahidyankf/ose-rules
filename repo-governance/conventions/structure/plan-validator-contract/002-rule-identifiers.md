---
description: >-
  Freezes the twenty plan-structure rule identifiers and the exact message each one emits.
when_to_use: >-
  Use when implementing a rule, matching on a diagnostic, or proposing a new rule.
---
