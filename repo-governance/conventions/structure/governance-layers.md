...
6. None of these: it is not governance. It is product documentation, a plan, or reference material — see
...
implement it; a changed convention may invalidate a workflow's steps.
[Principle Traceability](principle-traceability.md) is what makes those dependents findable rather than remembered.
