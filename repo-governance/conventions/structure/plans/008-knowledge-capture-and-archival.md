---
description: >-
  Requires every learning to reach a durable owner or be discarded with a reason, and fixes the archival sequence that
  closes a plan.
when_to_use: >-
  Use when routing learnings.md entries before archival, or when moving a finished plan into the done lifecycle root.
---
