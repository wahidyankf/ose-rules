---
description: >-
  Fixes the four canonical plan lifecycle roots, their exact spelling, and the stage-aware slug rules that apply to
  each.
when_to_use: >-
  Use when creating a plan folder, moving a plan between stages, or validating that live plan roots are named correctly.
---
