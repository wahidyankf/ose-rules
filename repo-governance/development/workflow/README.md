---
description: >-
  Indexes the workflow standards that govern how work is bounded, ordered, committed, integrated, and brought to a
  terminal state, and how a working environment and its toolchain are prepared.
when_to_use: >-
  Use when designing a repeated operation, when committing or integrating a change, when preparing an environment or
  toolchain, or when a process has no obvious stopping point.
---
