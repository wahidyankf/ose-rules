...
described the wrong behaviour, the specification is corrected in the same change, as
[Specification Maintenance](../../evidence/specification-maintenance.md) requires, and the test follows the corrected
statement.
