...
[Explicit Over Implicit](../../../principles/explicit-over-implicit.md). It decides what coverage may measure. Whether a
floor exists is recorded under [Layers and Adapters](behaviour-driven-development/002-layers-and-adapters.md). Which run
gates coverage, and how each exclusion is named, belong to [Test Boundaries and Gates](test-boundaries-and-gates.md). A
measured figure is read as [Trustworthy Measurement](../evidence/trustworthy-measurement.md) requires.
...
[Task Runner Target Standards](../../workflow/task-runner-target-standards.md) forbids. The stack standard names its
native verification.
...
[Software Quality Enforcement](../checks/software-quality-enforcement.md) treats as a change to a gate.
