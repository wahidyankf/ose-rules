...
- [Software Quality Enforcement](../checks/software-quality-enforcement.md) records that test-first order is proven by
  evidence, since a gate only sees the final state.
