...
[Consumer Independence](../../principles/consumer-independence.md) establishes that the surface is a contract and that
breaking it ships only as a major version. This standard fixes how the contract is declared and where the line between
compatible and breaking falls. It also implements [Explicit Over Implicit](../../principles/explicit-over-implicit.md)
and [Immutability](../../principles/immutability.md).
