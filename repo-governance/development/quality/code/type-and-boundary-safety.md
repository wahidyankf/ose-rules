...
[Evidence Over Assertion](../../../principles/evidence-over-assertion.md). It holds the language-neutral rule; each
...
check target that [Test Boundaries and Gates](../testing/test-boundaries-and-gates.md) names. Findings fail at the
...
later, in code that never saw the input. [Runtime File Data](runtime-file-data.md) and
[Environment Variable Contract](../../../conventions/security/environment-variable-contract.md) apply this rule to their
own boundaries.
