...
[One Source Per Fact](../../principles/one-source-per-fact.md), [Reproducibility](../../principles/reproducibility.md),
and [Fail Closed](../../principles/fail-closed.md).
...
A judgement category defines the predicate it applies, declares a criticality under
[Criticality Levels](finding-criticality-and-confidence/001-criticality-levels.md), and names the rule it enforces.
Where a deterministic check exists for the same rule, it delegates to that result rather than evaluating the rule again.
