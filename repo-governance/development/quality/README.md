...
description: >-
  ...
  is designed, tested, contracted, checked, delivered, and kept accessible.
when_to_use: >-
  Use when deciding how a change will be verified, or what a piece of evidence has to contain, or which design, code,
  testing, contract, delivery, accessibility, or repository-check standard applies.
---

# Quality Standards

Verification standards. They answer what proves a change works, and what a proof has to look like to be worth anything
to someone who was not there when it was produced. Design, code, testing, contract, delivery, interface, and
...
- [Checks and Gates](checks/README.md) — rule enforcement, which gate runs each check, strictness, validators, and what
  a new check needs
- [Code](code/README.md) — what code and dependencies justify, clarity, cross-file invariants, scripts, and data files
- [Deletion With Proof](deletion-with-proof.md) — what must be demonstrated before something is removed
- [Delivery](delivery/README.md) — live-service continuity, automation loop observability, and pipeline storage
