...
[Automation Over Manual](../../principles/automation-over-manual.md) says when automation pays in general; this is the
bar a specific check clears before it exists.
