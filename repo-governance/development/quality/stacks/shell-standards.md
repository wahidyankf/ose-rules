...
isolation per [Git Fixture Isolation](../testing/git-fixture-isolation.md) and
...
[Command-Line Interface](../../../conventions/structure/command-line-interface.md) at the tier the adopter records for
