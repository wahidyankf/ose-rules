...
[Criticality Levels](finding-criticality-and-confidence/001-criticality-levels.md), because the failure it permits
damages a real repository rather than a test result.
