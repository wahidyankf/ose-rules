...
[Criticality Levels](../evidence/finding-criticality-and-confidence/001-criticality-levels.md), and names the rule it
enforces. Where a deterministic check exists for the same rule, it delegates to that result rather than evaluating the
rule again.
