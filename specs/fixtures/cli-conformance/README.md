...
`assertions.json` is the machine-readable form of
[Command-Line Interface](../../../repo-governance/conventions/structure/command-line-interface.md). One assertion per
